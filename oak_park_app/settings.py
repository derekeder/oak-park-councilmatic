...
ROOT_URLCONF = "oak_park_app.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [BASE_DIR / "oak_park_app" / "templates"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "oak_park_app.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.parse(
        os.getenv(
            "DATABASE_URL",
            "postgis://postgres:postgres@localhost:5432/oak_park_councilmatic",
        ),
        conn_max_age=600,
...
HAYSTACK_CONNECTIONS = {
    "default": {
        ...
        "INDEX_NAME": "oak_park_councilmatic",
        "SILENTLY_FAIL": False,
    }
}
